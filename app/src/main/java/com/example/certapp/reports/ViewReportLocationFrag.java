...
public class ViewReportLocationFrag extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_report_location_frag);

        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            checkLocationPermission();
        }
        Intent intent=getIntent();
         myReportData = (ReportModel) intent.getSerializableExtra("myReportData");
